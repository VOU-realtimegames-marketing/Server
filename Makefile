...
.PHONY: postgres createdb dropdb migrateup migratedown migrateup1 migratedown1 new_migration sqlc proto wire redis rabbitmq auth counterpart gateway event quiz user game game_client
