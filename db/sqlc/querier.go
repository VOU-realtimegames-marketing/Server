...
type Querier interface {
	...
	GetBranchesByOwner(ctx context.Context, owner string) ([]GetBranchesByOwnerRow, error)
	...
	GetEventsByOwner(ctx context.Context, owner string) ([]GetEventsByOwnerRow, error)
	...
	GetVoucherOwnersByEvent(ctx context.Context, eventID int64) ([]GetVoucherOwnersByEventRow, error)
